import { getArticleById, getRelatedArticles, articles } from '@/lib/articles-data'
import { notFound } from 'next/navigation'
import Image from 'next/image'
import { Calendar, User, Building2, Eye, Download, Quote, FileText, Tag } from 'lucide-react'
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center space-x-8 py-6 border-t border-b border-gray-200">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <div className="text-2xl font-bold text-[#202124]">{article?.views ?? 0}</div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                <div className="text-2xl font-bold text-[#202124]">{article?.downloads ?? 0}</div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                <div className="text-2xl font-bold text-[#202124]">{article?.citations ?? 0}</div>
